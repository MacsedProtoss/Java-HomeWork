    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getAddTingsView(context,inflater,listData,dataManager,fileManager,adapter);

            }
        });
    }

    void getAddTingsView(final Context context, final LayoutInflater inflater,final List listData,final DataManager dataManager,final FileManager fileManager,final MainListAdapter adapter){
